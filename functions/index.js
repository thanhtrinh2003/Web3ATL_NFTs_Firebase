...
exports.generateHackerProof = functions.https.onRequest(async (req, res) => {
    ...
    res.writeResult = await admin.firestore().collection("ProofForAddress").add({hacker_proof: hackerProof});
...
exports.generateGeneralProof = functions.https.onRequest(async (req, res) => {
    ...
    res.writeResult = await admin.firestore().collection("ProofForAddress").add({hacker_proof: generalProof});
...
exports.generateTeamProof = functions.https.onRequest(async (req, res) => {
    ...
    res.writeResult = await admin.firestore().collection("ProofForAddress").add({hacker_proof: teamProof});
...
exports.generateSpeakerProof = functions.https.onRequest(async (req, res) => {
    ...
    res.writeResult = await admin.firestore().collection("ProofForAddress").add({hacker_proof: speakerProof});
